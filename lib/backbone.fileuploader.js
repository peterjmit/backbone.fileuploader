...
var FileUploader = Backbone.View.extend({
  // collection of files for the view to manage, alows for managing uploads
  files: null,
  ...
  setupFileUploader: function() {
    ...
    this.files = new this.options.FileCollection(null, { model: this.options.FileModel });
